		...
		<div align = "center">	
			<?php
				...
				{ 
					...
					$catID = $_SESSION['CatID_Next_Page'];
					
					//calculate the total number of rows in table 
					$total = $db->query("SELECT * FROM books WHERE Cat_ID = $catID;");
					...
					$result =$db->query("
						SELECT ISBN, BookTitle, Author, Edition, BookYear, Reserved 
						FROM books WHERE Cat_ID = $catID LIMIT $start_from ,5;");
					...
					if($result->num_rows > 0)
					{
						...
						{ 
							...
							echo "
								...
								href='DisplayPageCat.php?page=".$i."'>Page ".$i."</a> 
							</span>
							"; 
						}//end for
						echo '<span class = "PageNum"><a style = "color: #F77D2C;" href="SearchCat.php">New Search</a></span>';
					}//end if $result->num_rows > 0
					
					else
					{
						echo "<p class = 'error'>No books can be found that match the Category</p>";
						echo '<span class = "PageNumFirst"><a style = "color: #F77D2C;" href="SearchCat.php">New Search</a></span>';
					}//end else
