		...
		<div align = "center">	
			<?php
				...
				{ 
					...
					$author = $_SESSION['Aut_search2'];
					
					//calculate the total number of rows in table 
					$total_quer = 'SELECT * FROM Books WHERE (Author LIKE "%'.$author.'%");';
					...
					$quer = 'SELECT ISBN, BookTitle, Author, Edition, BookYear, Reserved FROM Books 
							 WHERE (Author LIKE "%'.$author.'%") LIMIT '.$start_from.',5;';
					...
					{
						echo "<p class = 'error'>No books can be found that match the Author</p>";
