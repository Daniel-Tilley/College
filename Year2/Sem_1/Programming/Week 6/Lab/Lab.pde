...
void setup()
{
  ...
  {
    Avg = Avg + sumData.get(i); 
  }//end for 
  
  Avg = (Avg / sumData.size());
  ...
  println("The year which contained the most moisture is: " + (int) map(highestIndex, 0, sumData.size() - 1, 1850, 2010) + " with rainfall of: " + sumData.get(highestIndex));
  println("The avg: " + Avg);
