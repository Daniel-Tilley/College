...
main()
{
    ...
    char name[101][4][50];//array to store data 
    char temp[101][4][50]; //temp array used for sorting
    ...
    else
    {
        ...
        while(i<file_lenght)
        {
            fprintf(fo,"Name: %s %s Address:%s",name[i][0],name[i][1],name[i][2]);
            i++;
        }//end while 
        
        //print success message 
        printf("\nFiles transfered to %s successfully\n",file1);
